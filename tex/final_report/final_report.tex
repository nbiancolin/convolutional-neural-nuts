...
Machine learning models often suffer from "unauthorized uses of copyrighted 'training data'". Training models can This exploits the work and copyrights of the dataset's creators,

\citep{Sobel.TaxonomyTrainingData.2021}. 
...
\textbf{Work to be completed:}
Iterative improvement to reduce training and inference times in code. Final evaluation of performance.


\subsection{Distribution Table}
\label{subsec:distribution_table}
